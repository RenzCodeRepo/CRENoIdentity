...
namespace CRE.Migrations
{
    ...
    [Migration("20241105114235_removedEvalIdFKOnDeclined")]
    partial class removedEvalIdFKOnDeclined
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRE.Models.EthicsEvaluationDeclined", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EthicsEvaluationDeclined");
                });
            ...
            modelBuilder.Entity("CRE.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("CRE.Models.EthicsEvaluationDeclined", b =>
                {
                    ...
                    b.HasOne("CRE.Models.EthicsApplication", "EthicsApplication")
                        .WithMany("EthicsEvaluationDeclined")
                        .HasForeignKey("urecNo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CRE.Models.EthicsApplication", b =>
                {
                    ...
                    b.Navigation("EthicsEvaluationDeclined");
