...
namespace CRE.Data
{
    public class Seed
    {
        ...
        ("Jose P Morales", new[] { "Faculty", "Evaluator" }),
        ("Katrina J Cruz", new[] { "Faculty", "Evaluator" }),
        ("Leon A Alvarez", new[] { "Faculty", "Evaluator" }),
        ("Mila I Villanueva", new[] { "Faculty", "Evaluator" }),
        ("Nina E Tan", new[] { "Faculty", "Evaluator" }),
        ("Omar M Reyes", new[] { "Faculty", "Evaluator" }),
        ("Pedro F Santiago", new[] { "Faculty", "Evaluator" }),
        ("Quincy R Pineda", new[] { "Faculty", "Evaluator" }),
        ("Ruby A Delos Santos", new[] { "Faculty", "Evaluator" }),
        ("Samuel D Bacalso", new[] { "Faculty", "Evaluator" }),
        ("Tina C Silva", new[] { "Faculty", "Evaluator" }),
        ("Ulysses J Lim", new[] { "Faculty", "Evaluator" }),
        ("Dante R Ponce", new[] { "Faculty", "Evaluator" }),
        ("Liza C Neri", new[] { "Faculty", "Evaluator" }),
        ("Lucas G Martinez", new[] { "Faculty", "Evaluator" }),
        ("Sofia L Villanueva", new[] { "Faculty", "Evaluator" }),
        ("Michael K Fernandez", new[] { "Faculty", "Evaluator" }),
        ("Aria M Palacios", new[] { "Faculty", "Evaluator" }),
        ("Bruno H Diaz", new[] { "Faculty", "Evaluator" }),
        ("Claudia C Ortega", new[] { "Faculty", "Evaluator" }),
        ("Daniel J Navarro", new[] { "Faculty", "Evaluator" }),
        ("Elisa F Garcia", new[] { "Faculty", "Evaluator" }),
        ("Marco A Xavier", new[] { "Faculty", "Evaluator" }),
        ("Maya E Yu", new[] { "Faculty", "Evaluator" }),
        ("Clara S Zamora", new[] { "Faculty", "Evaluator" }),
        ("Felix Q Torres", new[] { "Faculty", "Evaluator" }),
            };
